...
- Linguistic analysis of self-mention, appraisal, engagement, first-person verb frames, lexical density, epistemic classes, marker inventory, and data quality, with a searchable explorer for every table in `analysis/`.
